...
// TODO: add the service links to things got from backend env config or something using WEBGUI_ENDPOINT ...
export const serviceLinks: Tergite.ServiceLinkInfo[] = [
	{ href: '/webgui', text: 'GUI' },
	{ href: '/mss', text: 'API' }
];

// TODO: add the oauth2Providers as part of the backend env config
